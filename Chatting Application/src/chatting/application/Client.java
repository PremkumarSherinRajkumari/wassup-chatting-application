...
// Client class implements ActionListener interface
...
// Constructor for initializing the client GUI
    Client() {
 ...
 JPanel panel = new JPanel();
       ...
       // Setting up the typing and status labels in the top panel
...
// Setting up the frame properties
 ...
 // Method to send a typing indication to the server
    private void sendTypingIndication() {
        if (!isTyping) {
            try {
                dataOutputStream.writeUTF("Client is typing...");
            } catch (IOException e) {
                e.printStackTrace();
            }
            isTyping = true;
...
public void actionPerformed(ActionEvent ae) {
    ...
    statusLabel.setText("Online");
        ...
        if (!isFirstMessageReceived) {
            ...
            JOptionPane.showMessageDialog(null, "Server: You've got a message!");
        }
...
// Method to format the message label with optional delete button
...
public static JPanel formatLabel(String out) {
    ...
    if (!isTypingIndication) {
        ...
        deleteButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // Remove the message panel from the UI
    ...
    public static void main(String[] args) {
        // Creating an instance of the client GUI
        new Client();
