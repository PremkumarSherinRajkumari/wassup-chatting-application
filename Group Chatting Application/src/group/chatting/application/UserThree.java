...
public class UserThree implements ActionListener, Runnable {
   ...
   String usernamethree;
// Constructor to initialize the UserThree instance
    UserThree(String usernamethree) {
        ...
        // Adding DocumentListener to the text field
        ...
        frame.setLocation(950, Toolkit.getDefaultToolkit().getScreenSize().height - frame.getHeight() - 50);
    ...
    try {
        ...
        while (true) {
            ...
            SwingUtilities.invokeLater(() -> {
                JOptionPane.showMessageDialog(null, "UserThree: You've got a message!");
            });
